...
#define BLOCKS(a, b, c, d)              \
    ...
    d = _mm_aesenclast_si128(d, temp0);
...
int crypto_stream_xor(unsigned char *c, const unsigned char *m, unsigned long long l, const unsigned char *n, const unsigned char *k) {
    ...
    register __m128i temp0, temp1, temp2, X0, X1, X2, X3, K0, K1;
    ...
    if (l) {
        __attribute__((aligned(16))) unsigned char b[64] = {0};
        long long j;
