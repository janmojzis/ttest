...
int crypto_onetimeauth(unsigned char *o, const unsigned char *m, unsigned long long n, const unsigned char *k) {
...
int crypto_onetimeauth_verify(const unsigned char *h, const unsigned char *in, unsigned long long l, const unsigned char *k) {

    unsigned char correct[16];
    unsigned int d = 0;
    long long i;

    crypto_onetimeauth(correct, in, l, k);
